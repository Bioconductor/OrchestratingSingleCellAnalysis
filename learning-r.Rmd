...
We will not attempt to repeat the contents of these resources here, as they already to a good job of explaining themselves.
...
more experienced developers will consult [Writing R extensions](https://cran.r-project.org/doc/manuals/r-release/R-exts.html), 
the definitive documentation for the R packaging system.
