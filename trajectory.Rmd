...
The spliced counts are obtained in a more standard manner by counting reads aligned to exonic regions, though some extra thought is required to deal with reads spanning exon-intron boundaries.
