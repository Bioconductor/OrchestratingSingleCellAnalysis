...
A pseudotime value of $x$ in one path of the MST does not, in general, have any relation to the same value $x$ in another path;
...
Same effects could be achieved with cluster-based marker detection.
- Smoothness
- Resolution
