...
One can intepret a continuum of states as a series of closely related (but distinct) subpopulations, or two mostly well-separated clusters as the endpoints of a trajectory with rare intermediates.
...
However, more complex strategies are possible involving various generalizations to the concept of linear models.
