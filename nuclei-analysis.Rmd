...
We can also apply more complex procedures such as batch correction (Section \@ref(integrating-datasetse)).
...
Note that the set of detected markers may also differ from prior expectations, which is not too surprising given that transcripts for strongly expressed genes are more likely to localize to the cytoplasm for translation (and subsequently lost upon stripping). 
