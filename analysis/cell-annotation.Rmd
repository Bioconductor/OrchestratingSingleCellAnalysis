...
While simple, gene set testing of marker lists is the most reliable approach for detecting whether certain pathways are up- or down-regulated between clusters.
...
Unlike the other methods, there are no concerns about the validity of comparing scores across cells.
