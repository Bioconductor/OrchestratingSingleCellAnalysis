...
We identify phase-specific markers from the reference, restricting to genes with annotated roles in cell cycle.
...
common <- Reduce(intersect, list(rownames(sce.ref), rowData(sce.416b)$ENSEMBL,
    cycle.anno))
...
```{r}
# Switching row names back to Ensembl to match with reference.
...
gridExtra::grid.arrange(
    plotExpression(sce.ref, features="ENSMUSG00000027985", x="phases"),
