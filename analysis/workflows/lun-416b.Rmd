...
We can also examine the number of cells removed for each reason.
...
```{r unref-416b-norm, fig.cap="Relatoinship between the library size factors and the deconvolution size factors in the 416B dataset. Each cell is colored according to its oncogene induction status."}
