...
stopifnot(all(gad1==1))

gad2 <- sapply(marker.set["Gad2",-(1:3)], sign)
stopifnot(all(gad2==1))
```

The heatmap below indicates that most of the top markers are strongly DE in cells of cluster `r chosen.inter.cluster` compared to some or all of the other clusters.
