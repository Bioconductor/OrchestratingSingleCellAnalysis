...
extractCached("workflows/tenx-batch-pbmc/3k", "variance-modelling", c("pbmc3k", "dec3k"))
```
...
```{r, results='asis', echo=FALSE}
extractCached("workflows/tenx-batch-pbmc/4k", "variance-modelling", c("pbmc4k", "dec4k"))
```
