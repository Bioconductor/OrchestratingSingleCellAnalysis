...
A larger subset will reduce the risk of discarding interesting signal by retaining more potentially relevant genes, at the cost of increasing noise from irrelevant genes that might obscure said signal.
The simplest approach is to simply take the top $X$ genes with the largest values for the relevant variance metric.
...
Similarly, abundance-dependent changes in the magnitude of the chosen variance metric can influence the gene selection in a competitive manner.
...
This can lead to unexpected biases in the composition of the HVG selection.
