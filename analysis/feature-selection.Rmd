...
This is most useful in scenarios where a weak but consistent effect is present across many genes with small biological components.
...
(And admittedly, preservation of weak but consistent effects is not of major interest in most scRNA-seq studies, given the difficulty of experimentally validating population structure in the absence of strong marker genes.)
