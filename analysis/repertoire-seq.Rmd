...
More clonal expansion should generally result in lower diversity indicates as most cells are represented by a few clonotypes.
...
This analysis confirms that cluster `r greedy.bastard` contains the greatest number and extent of expanded clonotypes.
