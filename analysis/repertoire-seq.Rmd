...
Using the TCR $\alpha$-chain as an example, we assemble a matrix indicating whether each cell has any sequence,
...
test.out <- testGeneComboCountsPairwise(se.genes[,has.tcr])
test.out[["2"]]
```
