...
```{r kmeans-gp, fig.cap="Gap statistic with respect to increasing number of $k$-means clusters in the 10X PBMC dataset. The red line represents the chosen $k$."}
library(cluster)
...
Despite these issues, we will still demonstrate the application of hierarchical clustering as it is useful for squeezing as much information as possible from datasets with very few cells^[And, hey, this book isn't going to add padding to itself. Gotta write something to look productive.].
