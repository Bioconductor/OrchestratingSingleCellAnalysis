...
# Using a higher 'k' just for demonstration purposes here.
g.full <- buildSNNGraph(sce.pbmc, k=20, use.dimred = 'PCA')
...
g.memory <- buildSNNGraph(sce.memory, use.dimred="PCA", k=20)
