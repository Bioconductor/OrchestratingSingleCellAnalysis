...
```{r combined-tsne-naive, fig.cap="$t$-SNE plot of the PBMC dataset based on combined tag and transcript data. Each point is a cell and is colored according to the assigned cluster."}
...
```{r combined-heat, fig.cap="Distribution of cells in the combined clusters (rows) or the tag-only clusters (columns), where the color intensity is proportional to the log-number of cells with that combination of cluster labels."}
