...
We demonstrate this approach below by pretending that all immunoglobins are control proteins, though obviously one should use something more sensible in real analyses.
