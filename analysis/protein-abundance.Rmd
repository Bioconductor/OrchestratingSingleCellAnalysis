...
```{r combined-umap, fig.cap="UMAP plot obtained by combining transcript and tag data in the PBMC dataset. Each point represents a cell and is colored according to its assigned cluster."}
set.seed(1001010)
