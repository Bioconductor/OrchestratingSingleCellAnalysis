...
```{r heat-nmf-zeisel, fig.wide=TRUE, fig.asp="Heatmaps of the NMF results in the Zeisel brain dataset. Each column represents a factor while each row represents either a cell (left) or a gene (right).", eval=FALSE}
set.seed(101001)
