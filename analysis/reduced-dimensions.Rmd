...
```{r zeisel-pca, fig.wide=TRUE, fig.asp=1, fig.cap="PCA plot of the first two PCs in the Zeisel brain data. Each point is a cell, coloured according to the annotation provided by the original authors."}
...
Indeed, it would probably be unwise to directly analyze or interpret the low-dimensional coordinates used for plotting.
Rather, the plots are intended to be used to communicate the results of quantitative analyses based on a more accurate higher-rank representation of the data.
