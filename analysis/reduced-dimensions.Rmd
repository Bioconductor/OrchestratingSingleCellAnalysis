...
To handle this circularity, we test multiple choices for $d$ and we pick a value that is close to the number of clusters minus 1.
The analysis below suggests that 20-25 PCs would be the most suitable for the @zeisel2015brain data.
