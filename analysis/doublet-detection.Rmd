...
```{r hto-2to3-hash, fig.cap="Log-fold changes between the first, second and third most-abundant HTOs in each cell. Potential doublets are shown in red while confidently assigned singlets are shown in black."}
